package com.nineteen.pokeradar.util;
...
import com.nineteen.pokeradar.base.BaseApplication;
...
public class GoogleBillingUtil {
    ...
    public static String[] SUB_IDS = new String[]{"livegotracker_subscription05zhen_1month", "livegotracker_subscription05zhen_1month"};

    public String[] inAppSKUS = new String[]{};//内购ID,必填
    public String[] subsSKUS = new String[]{SUB_IDS[0]};//订阅ID,必填
    ...
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
